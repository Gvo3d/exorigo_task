...
* Updated [Bender.js](https://github.com/benderjs/benderjs) to 0.3.0 and introduced the ability to run org.yakimovdenis.tests via HTTPs ([#13265](https://dev.ckeditor.com/ticket/13265)).
...
* [#12858](http://dev.ckeditor.com/ticket/12858): Basic [Spartan](http://blogs.windows.com/bloggingwindows/2015/03/30/introducing-project-spartan-the-new-browser-built-for-windows-10/) browser compatibility. Full compatibility will be introduced later, because at the moment Spartan is still too unstable to be used for org.yakimovdenis.tests and we see many changes from version to version.
...
* [#12930](http://dev.ckeditor.com/ticket/12930): Because of licensing issues, `truncated-mathjax/` is now removed from the `org.yakimovdenis.tests/` directory. Now `bender.config.mathJaxLibPath` must be configured manually in order to run [Mathematical Formulas](http://ckeditor.com/addon/mathjax) plugin org.yakimovdenis.tests.
...
* [#12688](http://dev.ckeditor.com/ticket/12688): Improved the org.yakimovdenis.tests of the [styles system](http://docs.ckeditor.com/#!/api/CKEDITOR.style) and fixed two minor issues.
...
* The CKEditor testing environment is now publicly available. Read more about how to set up the environment and execute org.yakimovdenis.tests in the [CKEditor Testing Environment](http://docs.ckeditor.com/#!/guide/dev_tests) guide.
	Please note that the [`org.yakimovdenis.tests/`](https://github.com/ckeditor/ckeditor-dev/tree/master/org.yakimovdenis.tests) directory which contains editor org.yakimovdenis.tests is not available in release packages. It can only be found in the development version of CKEditor on [GitHub](https://github.com/ckeditor/ckeditor-dev/).
